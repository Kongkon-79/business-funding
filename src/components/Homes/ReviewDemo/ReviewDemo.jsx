...
export function CustomerReviews() {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto px-4 py-6 md:py-9 lg:py-12">
        ...
        {getVisibleReviews().map((review, idx) => (
          <div
            ...
            className={` relative bg-[#1B2A4E] text-white rounded-lg p-6 shadow-lg transition-all duration-500 ease-in-out w-2xl ${idx === 0 ? 'opacity-50 scale-90 md:-translate-x-[-10%] h-[280px]' :
                idx === 1 ? 'scale-105 z-20 h-[270px] md:h-[300px]' :
                  'opacity-50 scale-90 md:-translate-x-[10%] h-[280px]'
              }`}
          >
